...
import argparse
from models.Coattention import CoAtt
import numpy as np
import pandas as pd
...
class Instructor:
    def __init__(self, opt):
        ...
        self.model = CoAtt(opt, dataset.embedding_matrix, dataset.char_embedding_matrix).to(self.opt.device)
    ...
    def _test(self, epoch):
        ...
        submission.to_csv('results/coatt_epoch'+str(epoch)+'.csv', index=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_step', default=8, type=int)
